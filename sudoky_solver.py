...
for i in range(9):
    for j in range(9):
        lbl_box = tk.Label(master = frm_puzzle, text = "", font = (NUMBER_FONT, NUMBER_SIZE), bg = PUZZLE_BG_COLOR)
...
btn_solve = tk.Button(master = frm_buttons, text = "Solve", borderwidth = 4, bg = BUTTON_BG_COLOR, fg = "white", relief = BUTTON_RELIEF, command = GUI.solve_button)
btn_solve.grid(row = 0, column = 0, sticky = "nsew", padx = 20, pady = 5)

#Create reset button object
btn_reset = tk.Button(master = frm_buttons, text = "Reset", borderwidth = 4, bg = BUTTON_BG_COLOR, fg = "white", relief = BUTTON_RELIEF, command = GUI.reset_button)
btn_reset.grid(row = 0, column = 1, sticky = "nsew", padx = 20, pady = 5)

#Create help button object
btn_help = tk.Button(master = frm_buttons, text = "Help", borderwidth = 4, bg = BUTTON_BG_COLOR, fg = "white", relief = BUTTON_RELIEF, command = GUI.help_button)
btn_help.grid(row = 0, column = 2, sticky = "nsew", padx = 20, pady = 5)

#Create label object for error messages
lbl_error = tk.Label(master = frm_error, text = DEFAULT_ERROR_TEXT, fg = DEFAULT_ERROR_COLOR, bg = PUZZLE_BG_COLOR, relief = tk.SOLID)
